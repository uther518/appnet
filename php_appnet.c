...
#define REGISTER_APPNET_CLASS_CONST_STRING(const_name, value)                  \
  zend_declare_class_constant_stringl(AppnetServer, const_name,                \
	...
	REGISTER_STRING_CONSTANT( "APPNET_OPT_TASK_WORKER_NUM" , OPT_TASK_WORKER_NUM , CONST_CS | CONST_PERSISTENT );
	...
	REGISTER_STRING_CONSTANT( "APPNET_OPT_DAEMON" , OPT_DAEMON , CONST_CS | CONST_PERSISTENT );
