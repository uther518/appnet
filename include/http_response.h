...
static headerStatus http_status_20x[] = {
    {"200 OK", NULL_STRING},
...
static headerStatus http_status_30x[] = {
...
static headerStatus http_status_40x[] = {
...
static headerStatus http_status_50x[] = {
...
static char *header_formats[] = {
    ...
    "Server: %s" CRLF,   "Content-Type: %s" CRLF, "Content-Length: %d" CRLF,
    "Location: %s" CRLF, "Connection: %s" CRLF,   CRLF};
